...
{
    LOG_LIB_HDMI("%s:: hdmiResolutionValue = %d, forceRun = %d", __func__, hdmiResolutionValue, forceRun);
    ...
    if (forceRun == false && mHdmiResolutionValue == hdmiResolutionValue) {
        LOG_LIB_HDMI("%s::same hdmiResolutionValue(%d) \n", __func__, hdmiResolutionValue);
        return true;
    }
...
#if defined(BOARD_USE_V4L2)
        LOG_LIB_HDMI("%s:: mHdmiDstWidth = %d, mHdmiDstHeight = %d, mHdmiPresetId = 0x%x, hdmiResolutionValue = 0x%x\n",
                __func__,
                mHdmiDstWidth,
                mHdmiDstHeight,
                mHdmiPresetId,
                hdmiResolutionValue);
#else
        LOG_LIB_HDMI("%s:: mHdmiDstWidth = %d, mHdmiDstHeight = %d, mHdmiStdId = 0x%x, hdmiResolutionValue = 0x%x\n",
                __func__,
                mHdmiDstWidth,
                mHdmiDstHeight,
                mHdmiStdId,
